...
parser.add_argument('--save_dir', type=str, default="saved/mlsp/", help='')
#parser.add_argument('--load_pt', type=str, default="saved/kmeans/10.pt", help='')
...
while epoch < args.n_epoch:
    ...
    if epoch % args.eval_interval == 0:
        ...
        for n_node in [args.n_nodes]:
            dataset = pickle.load(open(args.eval_file_path + "/"  +'val_mlsp_' + str(n_node) + ".pkl", "rb"))
