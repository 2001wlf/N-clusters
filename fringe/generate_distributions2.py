...
def generate_i(gen_args):
    ...
    args.id = i
    p, q, f = generate_problem(args, init)
...
if __name__ == '__main__':
    ...
    feat = {"node_feat": x, # n_samples x n_nodes x 2
            ...
            "density_feat":np.array(fringe).reshape(-1,n_nodes,1) # n_samples x n_nodes x 1
            }
